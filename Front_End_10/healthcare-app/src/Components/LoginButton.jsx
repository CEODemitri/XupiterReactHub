...
function LoginButton() {
  ...
  return (
    <div>
      <button onClick={handleClick} className='inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-peru-500 text-gainsboro-50 hover:bg-primary/90 h-9 rounded-md px-3 ml-auto'>Log In</button>
      {isOpen && (
